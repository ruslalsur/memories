        ...
        <Grid container spacing={3}>
          <Grid item>
            ...
            <Paper className={classes.paperText}>
              ...
              <p>
                На этой странице, для примера, через некоторый интервал времени,
                показыаются случайным образом выбранные воспоминания
                пользователей, из набора доступных для всеобщего просмотра,
                нажав на которое можно будет увидеть остальные, разрешенные для
                просмотра, воспоминания пользователя, которому оно принадлежало.
              </p>
              <p>
