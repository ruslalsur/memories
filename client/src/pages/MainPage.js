...
import { IMAGES_PATH, RND_MEMORY_INTERVAL } from '../config.js'
    ...
    <Grid container spacing={2}>
      ...
      >
        <Grid container spacing={3}>
          <Grid item>
            <Box className={classes.titleText}>Воспоминания есть у каждого</Box>
            <Paper className={classes.paperText}>
              <p>
                ...
                просмотра всем. Воспоминания будут храниться под видом картотеки
                состоящей из карточек, в которых могут быть фотографии и
                связанные с ними высказывания c заголовком.
              </p>
              <p>
                На этой странице, через некоторый интервал времени, показыаются,
                случайным образом выбранные, воспоминания пользователей из
                набора доступных для всеобщего просмотра. Нажав на отображаемое
                воспоминание можно будет увидеть остальные, разрешенные для
                просмотра, воспоминания пользователя, которому оно принадлежит.
              </p>
              <p>
                Для воспоминаний реализованы CRUD-операции, доступные после
                авторизации, а также поиск по подстроке входящей либо в его
              ...
              <Box display='flex' justifyContent='flex-end'>
                <Button
                  target='_blank'
                  href='https://github.com/ruslalsur/memories'
                  color='primary'
                  size='small'
                >
